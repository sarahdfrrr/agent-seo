...
1. Read `seo-agent/agents/product-marketing-context.md` for the site URL and business context.
2. Read `seo-agent/agents/channels-seo.md` for the current inventory of pages and their known positions.
3. If a prior audit exists (`seo-agent/agents/seo-audit-report.md`), read it and compare — flag what's fixed, what's still open, what's new.
...
- Comparaison avec les 3 concurrents de `seo-agent/agents/competitors.md`
...
- Croiser `seo-agent/agents/channels-seo.md` : plusieurs pages qui ciblent le même keyword principal ?
...
**Outils :** Ahrefs `site-audit` si disponible, sinon crawl manuel léger sur les pages prioritaires listées dans `seo-agent/agents/channels-seo.md`.

---

## Deliver

Produire `seo-agent/agents/seo-audit-report.md` avec :
